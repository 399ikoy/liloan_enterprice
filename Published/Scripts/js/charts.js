$(document).ready(function () {
    ...
    */
    ...
    if ($('.dash-widget-visits')[0]) {
        sparklineLine('dash-widget-visits', [9,4,6,5,6,4,5,7,9,3,6,5,1,4,5,6], '100%', '95px', '#4285F4', 'rgba(0,0,0,0)', 2, 'rgba(21,119,203,0.4)', 'rgba(21,119,203,0.4)', 'rgba(21,119,203,0.4))', 5, 'rgba(21,119,203,0.4)', '#fff');
    }
